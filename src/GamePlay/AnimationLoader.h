...
class AnimationLoader {
    ...
    static bool readTranslateAndTimes(tinyxml2::XMLElement *nodeNode, Animation::AnimationForNode *animationForNode);
    static bool readScaleAndTimes(tinyxml2::XMLElement *nodeNode, Animation::AnimationForNode *animationForNode);
    static bool readRotationAndTimes(tinyxml2::XMLElement *nodeNode, Animation::AnimationForNode *animationForNode);
public:
